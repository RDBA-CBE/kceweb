...
const Footer = () => {
  const QUICK_LINKS = {
    title: "QUICK LINKS",
    links: [
      { label: "Policies and Regulations", href: "https://kce.ac.in/new/wp-content/uploads/2024/08/KCE_Policies_Rules-2024-25.pdf",target:"_blank" },
      { label: "AICTE Extension of Approval", href: "/KCE/approvals/aicte-eoa/" },
      { label: "Anna University Provisional Affiliation", href: "https://kce.ac.in/new/wp-content/uploads/2026/01/Anna-University-Affiliation-Copy-2025-26.pdf" ,target:"_blank"},
      { label: "Anna University – Permanent Affiliation", href: "https://kce.ac.in/new/wp-content/uploads/2021/11/Anna-University-Permanent-Affiliation.pdf",target:"_blank" },
      ...
      { label: "Institute Strategic Plan", href: "https://kce.ac.in/new/wp-content/uploads/2024/08/INSTITUTE-STRATEGIC-PLAN.pdf",target:"_blank" },
      { label: "Audit Report", href: "/KCE//audit-report/" },
      { label: "Handbook on Basics of Cyber Hygiene", href: "https://kce.ac.in/new/wp-content/uploads/2025/09/4580600_A_Handbook_on_Basics_of_Cyber_Hygiene.pdf" ,target:"_blank"},
    ],
  };
  ...
  const INFO_FOR = {
    ...
    links: [
      { label: "Karpagam Information & Admission Center's", href: "/KCE/karpagam-information-admission-centers/" },
      ...
      { label: "Admission Enquiry", href: "https://admission.kce.ac.in/" ,target:"_blank"},
