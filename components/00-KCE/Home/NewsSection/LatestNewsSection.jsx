...
export default function LatestNewsSection() {
  ...
  const featuredStories = [
    {
      ...
      description:
        "National Conference On 'sustainable Materials, Automotive Technologies And Artificial Intelligence (SMATAI)'",
    },
    {
      ...
      description:
        "Workshop on Machine Learning Techniques for EEG Processing and AI optimization.",
    },
    {
      ...
      description:
        "Showcasing the latest breakthroughs in collaborative robotics and automation.",
    },
  ];
  ...
  const eventsData = [
    ...
    },
    {
      ...
      day: "01",
      title:
        "Webinar on “Business Without Borders: Embracing Diversity in Leadership and Strategy”",
    },
    { month: "SEP", day: "26", title: "Debunking Menstrual Myths and Taboos" },
    {
      month: "SEP",
      day: "27",
      title: "One-Day Village Immersion Program at Sokkanoor village",
    },
    {
      month: "SEP",
      day: "17",
      title:
        "Industrial visit for its students to Lakshmi Machine Works (LMW), TMD – Unit 1",
    },
    {
      month: "SEP",
      day: "17",
      title: "Report on IDEA TO IPO: THE STARTUP JOURNEY",
    },
    {
      month: "DEC",
      day: "04",
    ...
    },
    {
      ...
      day: "01",
      title:
        "Report on Driving Logistics Efficiency in India: From Traditional Trucking to Tech-Driven Transport",
    },
  ];
